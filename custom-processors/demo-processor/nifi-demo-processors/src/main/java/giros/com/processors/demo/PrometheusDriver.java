 ...
 */
package giros.com.processors.demo;
...
@CapabilityDescription("NiFi demo processor to implement the Prometheus YANGTools Driver.")
@SeeAlso({})
...
public class PrometheusDriver extends AbstractProcessor {
    ...
    public String driver(JsonObject data) {
        ...
        try {
            ...
            Entry<YangInstanceIdentifier, NormalizedNode<?, ?>> normalized = codec.toNormalizedNode(iid, metric);
